...
%rename(msg_data_clone) pjsua_msg_data_clone;
%javamethodmodifiers pjsua_msg_data_clone(pj_pool_t *pool,
                                              const pjsua_msg_data *rhs) "public synchronized";
...
%rename(acc_get_config) pjsua_acc_get_config;
%javamethodmodifiers pjsua_acc_get_config(pjsua_acc_id acc_id,
                                          pjsua_acc_config *acc_cfg) "public synchronized";
...
%rename(call_setting_default) pjsua_call_setting_default;
%javamethodmodifiers pjsua_call_setting_default(pjsua_call_setting *opt) "public synchronized";
%rename(call_vid_strm_op_param_default) pjsua_call_vid_strm_op_param_default;
%javamethodmodifiers pjsua_call_vid_strm_op_param_default(pjsua_call_vid_strm_op_param *param) "public synchronized";
...
%rename(call_answer2) pjsua_call_answer2;
%javamethodmodifiers pjsua_call_answer2(pjsua_call_id call_id, 
					const pjsua_call_setting *opt,
				        unsigned code,
				        const pj_str_t *reason,
				        const pjsua_msg_data *msg_data) "public synchronized";
...
%javamethodmodifiers pjsua_call_reinvite(pjsua_call_id call_id,
					 unsigned options,
					 const pjsua_msg_data *msg_data) "public synchronized";
%rename(call_reinvite2) pjsua_call_reinvite2;
%javamethodmodifiers pjsua_call_reinvite2(pjsua_call_id call_id,
					  const pjsua_call_setting *opt,
					  const pjsua_msg_data *msg_data) "public synchronized";
...
%javamethodmodifiers pjsua_call_update(pjsua_call_id call_id,
				       unsigned options,
				       const pjsua_msg_data *msg_data) "public synchronized";
%rename(call_update2) pjsua_call_update2;
%javamethodmodifiers pjsua_call_update2(pjsua_call_id call_id,
				        const pjsua_call_setting *opt,
				        const pjsua_msg_data *msg_data) "public synchronized";
...
%rename(call_get_vid_stream_idx) pjsua_call_get_vid_stream_idx;
%javamethodmodifiers pjsua_call_get_vid_stream_idx(pjsua_call_id call_id) "public synchronized";
%rename(call_vid_stream_is_running) pjsua_call_vid_stream_is_running;
%javamethodmodifiers pjsua_call_vid_stream_is_running(pjsua_call_id call_id,
                                                    int med_idx,
                                                    pjmedia_dir dir) "public synchronized";
%rename(call_set_vid_strm) pjsua_call_set_vid_strm;
%javamethodmodifiers pjsua_call_set_vid_strm (
				pjsua_call_id call_id,
				pjsua_call_vid_strm_op op,
				const pjsua_call_vid_strm_op_param *param) "public synchronized";
%rename(call_get_stream_info) pjsua_call_get_stream_info;
%javamethodmodifiers pjsua_call_get_stream_info(pjsua_call_id call_id,
                                                unsigned med_idx,
                                                pjsua_stream_info *psi) "public synchronized";
%rename(call_get_stream_stat) pjsua_call_get_stream_stat;
%javamethodmodifiers pjsua_call_get_stream_stat(pjsua_call_id call_id,
                                                unsigned med_idx,
                                                pjsua_stream_stat *stat) "public synchronized";
%rename(call_get_med_transport_info) pjsua_call_get_med_transport_info;
%javamethodmodifiers pjsua_call_get_med_transport_info(pjsua_call_id call_id,
                                  unsigned med_idx,
                                  pjmedia_transport_info *t) "public synchronized";
...
%rename(vid_dev_count) pjsua_vid_dev_count;
%javamethodmodifiers pjsua_vid_dev_count(void) "public synchronized";
%rename(vid_dev_get_info) pjsua_vid_dev_get_info;
%javamethodmodifiers pjsua_vid_dev_get_info(pjmedia_vid_dev_index id,
                                            pjmedia_vid_dev_info *vdi) "public synchronized";
%rename(vid_enum_devs) pjsua_vid_enum_devs;
%javamethodmodifiers pjsua_vid_enum_devs(pjmedia_vid_dev_info info[],
					 unsigned *count) "public synchronized";
%rename(vid_preview_param_default) pjsua_vid_preview_param_default;
%javamethodmodifiers pjsua_vid_preview_param_default(pjsua_vid_preview_param *p) "public synchronized";
%rename(vid_preview_has_native) pjsua_vid_preview_has_native;
%javamethodmodifiers pjsua_vid_preview_has_native(pjmedia_vid_dev_index id) "public synchronized";
%rename(vid_preview_start) pjsua_vid_preview_start;
%javamethodmodifiers pjsua_vid_preview_start(pjmedia_vid_dev_index id,
                                             const pjsua_vid_preview_param *p) "public synchronized";
%rename(vid_preview_get_win) pjsua_vid_preview_get_win;
%javamethodmodifiers pjsua_vid_preview_get_win(pjmedia_vid_dev_index id) "public synchronized";
%rename(vid_preview_stop) pjsua_vid_preview_stop;
%javamethodmodifiers pjsua_vid_preview_stop(pjmedia_vid_dev_index id) "public synchronized";
%rename(vid_enum_wins) pjsua_vid_enum_wins;
%javamethodmodifiers pjsua_vid_enum_wins(pjsua_vid_win_id wids[],
					 unsigned *count) "public synchronized";
%rename(vid_win_get_info) pjsua_vid_win_get_info;
%javamethodmodifiers pjsua_vid_win_get_info(pjsua_vid_win_id wid,
                                            pjsua_vid_win_info *wi) "public synchronized";
%rename(vid_win_set_show) pjsua_vid_win_set_show;
%javamethodmodifiers pjsua_vid_win_set_show(pjsua_vid_win_id wid,
                                            pj_bool_t show) "public synchronized";
%rename(vid_win_set_pos) pjsua_vid_win_set_pos;
%javamethodmodifiers pjsua_vid_win_set_pos(pjsua_vid_win_id wid,
                                           const pjmedia_coord *pos) "public synchronized";
%rename(vid_win_set_size) pjsua_vid_win_set_size;
%javamethodmodifiers pjsua_vid_win_set_size(pjsua_vid_win_id wid,
                                            const pjmedia_rect_size *size) "public synchronized";
%rename(vid_win_rotate) pjsua_vid_win_rotate;
%javamethodmodifiers pjsua_vid_win_rotate(pjsua_vid_win_id wid,
					  int angle) "public synchronized";
%rename(vid_enum_codecs) pjsua_vid_enum_codecs;
%javamethodmodifiers pjsua_vid_enum_codecs( pjsua_codec_info id[],
					    unsigned *count ) "public synchronized";
%rename(vid_codec_set_priority) pjsua_vid_codec_set_priority;
%javamethodmodifiers pjsua_vid_codec_set_priority( const pj_str_t *codec_id,
						   pj_uint8_t priority ) "public synchronized";
%rename(vid_codec_get_param) pjsua_vid_codec_get_param;
%javamethodmodifiers pjsua_vid_codec_get_param(
					const pj_str_t *codec_id,
					pjmedia_vid_codec_param *param) "public synchronized";
%rename(vid_codec_set_param) pjsua_vid_codec_set_param;
%javamethodmodifiers pjsua_vid_codec_set_param( 
					const pj_str_t *codec_id,
					const pjmedia_vid_codec_param *param) "public synchronized";
