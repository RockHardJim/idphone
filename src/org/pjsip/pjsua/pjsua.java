...
public class pjsua implements pjsuaConstants {
  ...
  public synchronized static SWIGTYPE_p_pjsua_msg_data msg_data_clone(pj_pool_t pool, SWIGTYPE_p_pjsua_msg_data rhs) {
    long cPtr = pjsuaJNI.msg_data_clone(pj_pool_t.getCPtr(pool), pool, SWIGTYPE_p_pjsua_msg_data.getCPtr(rhs));
    return (cPtr == 0) ? null : new SWIGTYPE_p_pjsua_msg_data(cPtr, false);
  }
  ...
  public synchronized static int call_make_call(int acc_id, pj_str_t dst_uri, pjsua_call_setting opt, byte[] user_data, SWIGTYPE_p_pjsua_msg_data msg_data, int[] p_call_id) {
    return pjsuaJNI.call_make_call(acc_id, pj_str_t.getCPtr(dst_uri), dst_uri, pjsua_call_setting.getCPtr(opt), opt, user_data, SWIGTYPE_p_pjsua_msg_data.getCPtr(msg_data), p_call_id);
  }
  ...
  public synchronized static int call_answer2(int call_id, pjsua_call_setting opt, long code, pj_str_t reason, SWIGTYPE_p_pjsua_msg_data msg_data) {
    return pjsuaJNI.call_answer2(call_id, pjsua_call_setting.getCPtr(opt), opt, code, pj_str_t.getCPtr(reason), reason, SWIGTYPE_p_pjsua_msg_data.getCPtr(msg_data));
  }
  ...
  public synchronized static int call_reinvite2(int call_id, pjsua_call_setting opt, SWIGTYPE_p_pjsua_msg_data msg_data) {
    return pjsuaJNI.call_reinvite2(call_id, pjsua_call_setting.getCPtr(opt), opt, SWIGTYPE_p_pjsua_msg_data.getCPtr(msg_data));
  }
  ...
  public synchronized static int call_update2(int call_id, pjsua_call_setting opt, SWIGTYPE_p_pjsua_msg_data msg_data) {
    return pjsuaJNI.call_update2(call_id, pjsua_call_setting.getCPtr(opt), opt, SWIGTYPE_p_pjsua_msg_data.getCPtr(msg_data));
  }
  ...
  public static pj_str_t call_secure_info(int call_id) {
    return new pj_str_t(pjsuaJNI.call_secure_info(call_id), true);
  }
  ...
  public static int vid_set_android_window(int call_id, Object window) {
    return pjsuaJNI.vid_set_android_window(call_id, window);
  }

  public static void jzrtp_SASVerified(int zrtp_data_p) {
    pjsuaJNI.jzrtp_SASVerified(zrtp_data_p);
  }

  public static int jzrtp_getCallId(int zrtp_data_p) {
    return pjsuaJNI.jzrtp_getCallId(zrtp_data_p);
  }
